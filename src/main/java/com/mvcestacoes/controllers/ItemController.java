...
public class ItemController {
    ...
    public ModelAndView adicionarItemPreenchido(ItemContrato item, String contrato_cpf_cnpj, String contrato_valor, LocalDate dataVencimento, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("dataVencimento", dataVencimento);
